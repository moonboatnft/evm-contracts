 ...
 */
contract NFTExchange is INFTExchange, ReentrancyGuardUpgradeable, EIP712, OwnableUpgradeable, UUPSUpgradeable {
    ...
    /* Constants */
    string public constant NAME = "Moonboat Exchange";
    string public constant VERSION = "1.0";
    uint256 public constant INVERSE_BASIS_POINT = 10_000;
    address public constant WETH = 0xc00592aA41D32D137dC480d9f6d0Df19b860104F; // WEOS
    ...
    function setPool(address _pool)
        ...
        onlyOwner
    {
        require(_pool != address(0), "Address cannot be zero");
        pool = _pool;
        emit NewPool(pool);
    }
